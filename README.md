...
```git clone https://github.com/diegoandcontroll/simple-microservices-with-spring.git```
2. Run docker-compose to up postgres service

    ```docker-compose up -d ```
3. Navigate to the project directory:
4. Build and package each component with Maven:
...
API Gateway serves as the single entry point for all client requests, managing and routing them to the appropriate microservices.
